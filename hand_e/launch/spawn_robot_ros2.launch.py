...
def generate_launch_description():
    ...
    ####### DATA INPUT ##########
    xacro_file = "hand_e.urdf.xacro"

    package_description = "hand_e"

    # Position and orientation
    # [X, Y, Z]
    position = [0.0,0.0,0.228302]     
    # position = [9.8, -0.9, 0.228302]     # For Testing    
    
    # [Roll, Pitch, Yaw]
    orientation = [0.0, 0.0, 0.0] 
    # orientation = [0.0, 0.0, -1.25] # For Testing
    # Base Name or robot
    robot_base_name = "hand_e"
    ####### DATA INPUT END ##########
